    ...
    <table rules="all" border="1" style="border: 1px solid" cellpadding="5">
      <tbody>
        ...
        <tr>
          ...
          <td width="85">&nbsp;</td>
          <td width="264">
            <p>臺北市中山區中山北路三段62-2號4樓</p>
          </td>
          <td width="152">&nbsp;</td>
          <td width="76">&nbsp;</td>
          <td width="85">&nbsp;</td>
          <td width="179">
            <p>團練時間：週一到六15:00-16:00</p>
          </td>
        </tr>
        <tr>
          <td width="189">
        ...
        <tr>
          ...
          <td width="264">
            <p>臺北市大安區信義路三段157巷11號（客家文化會館 地下室）</p>
            <p>02-2771-0794</p>
          </td>
          <td width="152">
        ...
        <tr>
          ...
          <td width="179">
            <p>客家歌謠課：每星期四20:00-22:00</p>
            <p>客家舞劇課：每週六20:00-21:00</p>
          </td>
        </tr>
        <tr>
          <td width="189">
