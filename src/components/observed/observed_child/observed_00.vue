...
const tabs = [
  ...
  {
    name: '2022年度泰雅族、鄒族、邵族、布農族、噶瑪蘭族、賽德克族音樂活動觀察與評介',
    autor: '魏心怡',
    component: Observed6,
    path: 'observed_6',
  },
  {
    name: '2022年度排灣族、魯凱族、卡那卡那富族、拉阿魯哇族、平埔族音樂活動觀察與評介',
    autor: '周明傑',
    component: Observed7,
    path: 'observed_7',
  },
  // {
  //   name: '2022年度邵族、布農族、噶瑪蘭族、賽德克族音樂活動觀察與評介',
  //   autor: '魏心怡',
  //   component: Observed8,
  //   path: 'observed_8',
  // },
  {
    name: '2022年度佛教、釋教音樂活動觀察與評介',
    autor: '何麗華',
    component: Observed9,
    path: 'observed_9',
  },
